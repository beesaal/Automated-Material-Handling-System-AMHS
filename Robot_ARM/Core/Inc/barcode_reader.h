...
extern I2C_HandleTypeDef hi2c1; // Assuming I2C1 is used for QR scanner

#define QR_SCANNER_I2C_ADDR 0x3C << 1  // Replace 0x3C with actual I2C address
#define BUFFER_SIZE 100

char qr_data[BUFFER_SIZE];      // Buffer to store QR data
volatile int data_received = 0; // Flag to indicate data received (volatile for ISR safety)
